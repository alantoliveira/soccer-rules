...
\rfoot{Pag \textbf{\thepage} de \textbf{\pageref{LastPage}}}
\lfoot{\textit{Regras Atualizadas em \today}}
\cfoot{}

% First page
\fancypagestyle{firststyle}{%
  \fancyhf{}
  \fancyfoot[L]{\textit{Regras Atualizadas em \today}}
  \renewcommand{\pagename}{Página}
  \fancyfoot[R]{Pag \textbf{\thepage} de \textbf{\pageref{LastPage}}}
  \fancyhead[R]{\includegraphics[width=8cm]{media/image15.png}}
}

\title{\vspace{-5ex}CBR - RoboCupJunior Soccer Regras 2025\vspace{-5ex}}
\date{\vspace{-2ex}}

...
if __name__ == '__main__':
    cmp = CriticMarkupPreprocessor(
        ...
        deletion_replacement_fmt='footnote:[Na versão anterior dizia "{PREVIOUS}"]', # noqa
        substitution_note_fmt='Alterado "{PREVIOUS}" para "{CURRENT}"',
        substitution_replacement_fmt='[red]#*{CURRENT}*#\nfootnote:[Na versão anterior dizia "{PREVIOUS}"]'  # noqa
    )
